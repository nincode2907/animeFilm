    ...
    for (let index = 0; index < length; index++) {
      indexPagination.push(
        <div
          ...
          className="w-7 h-7 bg-amber-400 text-white flex items-center justify-center rotate-45"
        >
    ...
    return (
      <div>
        <div className="mx-auto lg:w-4/5 min-h-screen z-0  my-4 relative">
          <div className="font-medium transition duration-300 ease-in text-slate-50 bg-amber-400 dark:text-gray-500 pl-4 py-2 drop-shadow-xl w-full dark:bg-lime-300">
            Nổi bật
          </div>
          <SlideShow
            size={4}
