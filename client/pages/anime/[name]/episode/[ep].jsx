...
const DynamicWatch = () => {
  ...
  return (
    <div className="lg:mx-auto lg:w-3/4 w-full bg-slate-200 dark:bg-slate-50/50 min-h-screen mt-3">
      <div className="bg-amber-500 dark:bg-lime-400 text-white text-lg py-3 px-4">
        {name} - tập {ep}
      </div>
      <div className="flex flex-col sm:flex-row justify-center my-4">
        ...
        <div className="basis-3/4 sm:p-4">
          <video
            className="min-h-24 md:max-h-[30rem] w-full bg-black rounded-md"
            controls
            ref={src}
          >
            <source src={video} className="w-full h-full " />
          </video>
          <div className="mt-3 flex items-center justify-between text-xl text-white bg-amber-500 dark:bg-lime-400 h-10 rounded-md">
        ...
        <div className="basis-1/4">
          <div className="bg-amber-500 dark:bg-lime-400 text-white py-3 mt-4 sm:mt-0 text-lg pl-4 sm:rounded-tl-full sm:rounded-bl-full  ">
            Các tập khác
          </div>
              ...
              <Link href={`/anime/${name}/episode/${item.epsisode.toString()}`}>
                <div
                  ...
                  className={`inline-block ${
                    index === ep - 1
                      ? "bg-lime-400 dark:bg-amber-500"
                      : "bg-amber-500 dark:bg-lime"
