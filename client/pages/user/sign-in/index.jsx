...
const index = () => {
  return (
    <div className="min-h-screen w-full text- flex  items-center justify-center">
      <div className="w-[30rem] h-[30rem] dark:bg-lime-400 bg-yellow-600 rounded-full flex flex-col items-center justify-center">
