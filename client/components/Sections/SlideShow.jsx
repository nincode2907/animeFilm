  ...
  return (
    <div className="h-96 overflow-hidden relative group md:bg-gray-300/50 md:dark:bg-neutral-500/30 md:rounded-lg my-4 py-4 md:dark:shadow-infull md:dark:shadow-lime-200">
      <div className="relative flex h-full w-11/12 mx-auto  ">
        ...
        <div className="md:basis-1/2 overflow-x-hidden relative flex flex-col gap-4 rounded-tl-md rounded-bl-md bg-black/50 h-full py-4 px-3 text-orange-400 dark:text-lime-400">
          ...
          <div className="basis-3/5 border-y-2 border-x-none border-orange-400 dark:border-lime-400 lg:py-5 py-3 px-2 overflow-y-auto ">
          ...
          >
            <div className="bg-orange-400 hover:text-stone-700 dark:bg-lime-400 text-white font-semibold text-lg w-40 text-center rounded-md py-3">
      ...
      <div
        className="absolute left-2 top-1/2 -translate-y-1/2 group-hover:opacity-100 opacity-0 duration-500 text-2xl text-white dark:text-lime-200 w-12 h-12 rounded-full bg-orange-400 dark:bg-slate-500/70 cursor-pointer dark:hover:bg-slate-500 flex justify-center items-center"
        onClick={() => prevSlide()}
      >
        <FontAwesomeIcon icon={faAngleLeft} />
      </div>
      <div
        className="absolute right-2 top-1/2 -translate-y-1/2 group-hover:opacity-100 opacity-0 duration-500 text-2xl text-white dark:text-lime-200 w-12 h-12 rounded-full bg-orange-400 dark:bg-slate-500/70 cursor-pointer dark:hover:bg-slate-500 flex justify-center items-center"
        onClick={() => nextSlide()}
      >
